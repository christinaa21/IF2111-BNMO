...
compile:
	@gcc -o main ./main.c ./src/ADT/arrayOfGame/arrayOfGame.c ./src/ADT/mesinkata/mesinkata.c ./src/ADT/mesinkata/mesinkarakter.c ./src/ADT/prioQueue/prioqueue.c ./src/ADT/queue/queue.c ./src/game_util/game_util.c ./src/games/diner_dash/diner_dash.c ./src/games/game_tambahan/game_tambahan.c ./src/games/random_number_generator/random_number_generator.c ./src/games/hangman/hangman.c ./src/games/TicTacToe/tictactoe.c ./src/main_util/main_util.c ./src/ADT/list/list.c ./src/ADT/array/arraydin.c ./src/ADT/stackchar/stackchar.c ./src/ADT/stack/stack.c ./src/games/TowerOfHanoi/TowerOfHanoi.c ./src/games/SnakeOfMeteor/snakeofmeteor.c ./src/ADT/LinkedList/listdp.c ./src/ADT/Map/listMap.c ./src/ADT/Map/map.c ./src/ADT/Point/point.c ./src/ADT/set/set.c
